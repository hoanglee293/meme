...
export default function CreateCoinForm() {
  ...
  const ethereumIcon = (width: number, height: number) => {
    return (
      <Image src={ethereum} alt="ethereum-icon" width={width} height={height} />
    );
  };
  return (
                ...
                <div className="w-1/2">
                  ...
                  <div className="relative">
                    <Select>
                      ...
                      <SelectContent
                        className={
                          "bg-white dark:bg-neutral-900 box-shadow-info rounded-xl z-10 "
                        }
                      >
                        {CATEGORIES.map((category) => (
                          <SelectItem
                            className="text-gray-700 dark:text-neutral-400 cursor-pointer hover:bg-gray-100 dark:hover:bg-transparent"
                            value={category}
                          >
                            {category}
                          </SelectItem>
