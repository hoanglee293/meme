...
export default function TokenInfo() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="bg-neutral-1000 box-shadow-info rounded-xl p-3 h-full flex flex-col xl:min-w-[328px]">
        <div className="flex items-start gap-3 mb-3">
          ...
          <button className="ml-auto">
            <Star className="w-5 h-5 text-neutral-500 hover:text-yellow-400" />
          </button>
        </div>
